class MobileMenu {
  ...
  openMenu() {
    ...
    if (this.container.classList.contains('overlay')) {
      this.mobileMenuIcon.src = '/wp-content/themes/wp-starter-theme/theme/images/header/close.webp';
      ...
      this.mobileMenuIcon.src = '/wp-content/themes/wp-starter-theme/theme/images/header/hamburger-menu.webp';
